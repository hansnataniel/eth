...
@section('page_title')
	Purchase
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Purchase</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Purchase
		</li>
		<li>
			Gunakan tombol Confirm di dalam tombol Action untuk mengkonfirmasi Purchase
		</li>
		<li>
			Gunakan tombol Decline di dalam tombol Action untuk mendecline Purchase
		</li>
	</ul>
@endsection
							...
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/purchase/' . $purchase->id)}}">
