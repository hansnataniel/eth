...
@section('page_title')
	User Group Edit
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/usergroup')}}">User Group</a> / <span>User Group Edit</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::model($usergroup, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/usergroup/' . $usergroup->id), 'method' => 'PUT', 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
								...
								<div class="edit-form-group">
									<table class="index-table" style="border-top: 1px solid #d2d2d2; border-bottom: 1px solid #d2d2d2;">
										...
										<tr>
											...
											<td>
												{!!Form::checkbox('profile_r', true, $usergroup->profile_r, ['class'=>'childAll childTrigger'])!!}
												<div class="checkClose"></div>
											</td>
											<td>
												{!!Form::checkbox('profile_u', true, $usergroup->profile_u, ['class'=>'childAll childTriggered'])!!}
												<div class="checkClose"></div>
											</td>
											<td>
											</td>
										...
										<tr>
											...
											<td>
												{!!Form::checkbox('gallery_r', true, $usergroup->gallery_r, ['class'=>'childAll childTrigger'])!!}
												<div class="checkClose"></div>
											</td>
											<td>
												{!!Form::checkbox('gallery_u', true, $usergroup->gallery_u, ['class'=>'childAll childTriggered'])!!}
												<div class="checkClose"></div>
											</td>
											<td>
											</td>
