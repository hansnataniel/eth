...
@section('page_title')
	User Group
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>User Group</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari User Group
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk meng-edit User group
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus User group
		</li>
	</ul>
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/usergroup/create')}}">
				...
				<table class="index-table">
					...
					@foreach ($usergroups as $usergroup)
						...
						<tr>
							...
							<td>
								{!!$usergroup->is_active == true ? "<span class='text-green'>Active</span>":"<span class='text-red'>Not Active</span>"!!}
							</td>
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 200px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/usergroup/' . $usergroup->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/usergroup/' . $usergroup->id . '/edit')}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/usergroup/' . $usergroup->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
				...
				{{-- 
					Pagination
				 --}}
				{{$usergroups->appends($criteria)->links()}}
			</div>
		</div>
	</div>
@endsection