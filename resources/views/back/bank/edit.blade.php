	...
	<script type="text/javascript">
		$(function(){
			$('.edit-form-image-delete').click(function(){
		    	...
		    	$.ajax({
		    		type: 'GET',
		    		url: "{{URL::to(Crypt::decrypt($setting->admin_url) . '/bank/delete-image')}}/"+value,
...
@section('page_title')
	Bank Edit
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/bank')}}">Bank</a> / <span>Bank Edit</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::model($bank, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/bank/' . $bank->id), 'method' => 'PUT', 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
