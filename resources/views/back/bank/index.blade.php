...
@section('page_title')
	Bank
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Bank</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Bank
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Bank
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Bank
		</li>
	</ul>
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/bank/create')}}">
				...
				<table class="index-table">
					...
					@foreach ($banks as $bank)
						...
						<tr>
							...
							<td>
								{!!$bank->is_active == true ? "<span class='text-green'>Active</span>":"<span class='text-red'>Not Active</span>"!!}
							</td>
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/bank/' . $bank->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/bank/' . $bank->id . '/edit')}}">
									...
									<div class="index-del-content">
										<div class="index-del-title index-del-item">
											Do you really want to delete this bank?
										</div>
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/bank/' . $bank->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
