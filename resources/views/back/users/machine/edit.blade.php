...
@section('page_title')
	Machine Edit
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/user')}}">User</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/user/machine/' . $machine->user_id)}}">Machine</a> / <span>Machine Edit</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::model($machine, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/user/machine-edit/' . $machine->user_id), 'method' => 'POST', 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
							...
							<div class="page-item-content edit-item-content">
								<div class="edit-form-group">
									...
									{!!Form::text('machine_id', $machine->machine_id, ['class'=>'edit-form-text large', 'readonly', 'required', 'style'=>'font-size: 18px; padding: 0px; border: 0px !important; font-weight: bold;'])!!}
								</div>
								<div class="edit-form-group">
