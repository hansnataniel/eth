...
@section('page_title')
	Machine List
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/user')}}">User</a> / <span>Machine List</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Machine
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Machine
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Machine
		</li>
	</ul>
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/user/machine-create/' . $user->id)}}">
				...
				<table class="index-table">
					...
					@foreach ($machines as $machine)
						...
						<tr>
							...
							<td>
								{!!$machine->is_active == true ? "<span class='text-green'>Active</span>":"<span class='text-red'>Not Active</span>"!!}
							</td>
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 190px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/user/machine-show/' . $machine->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/user/machine-edit/' . $machine->id)}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/user/machine-delete/' . $machine->id), 'method' => 'POST', 'class'=>'form index-del-item'])!!}
