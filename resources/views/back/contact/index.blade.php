...
@section('page_title')
	Contact
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Contact</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Contact
		</li>
		<li>
			Gunakan tombol Confirm di dalam tombol Action untuk mengkonfirmasi Contact
		</li>
		<li>
			Gunakan tombol Decline di dalam tombol Action untuk mendecline Contact
		</li>
	</ul>
@endsection
...
@section('search')
	{!!Form::open(['URL' => URL::current(), 'method' => 'GET'])!!}
		<div class="menu-group">
			...
			<div class="menu-search-group">
				{!!Form::label('src_subject', 'Subject', ['class'=>'menu-search-label'])!!}	
				{!!Form::text('src_subject', '', ['class'=>'menu-search-text'])!!}
			</div>
		</div>
		...
		<div class="page-item col-1">
			<div class="page-item-content">
							...
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/contact/' . $contact->id)}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/contact/' . $contact->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
				...
				{{-- 
					Pagination
				 --}}
				{{$contacts->appends($criteria)->links()}}
			</div>
		</div>
	</div>
@endsection