...
@section('head_additional')
	...
	{!!HTML::style('css/back/indeximageportrait.css')!!}
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				@foreach ($slideshows as $slideshow)
					...
					@if(($counter - 1) % 2 == 0)
						<div class="page-group sld-group">
					@endif

					<div class="page-item col-2-4 sld-item sld-portrait">
					...
					@if(($counter % 2 == 0) OR ($counter == $totalcounter))
						</div>
					@endif
				@endforeach
			</div>
