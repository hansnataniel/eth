				...
				@foreach ($slideshows as $slideshow)
					...
					@endif
						<div class="page-item col-1-4 sld-item">
							<div class="sld-img" style="background: url('<?php echo URL::to('usr/img/slideshow/' . $slideshow->id . '_' . Str::slug($slideshow->filename, '_') . '_thumb.jpg?lastmod=' . Str::random(5)); ?>')"></div>
