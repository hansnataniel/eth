	...
	<script>
		$(function(){
			$('.edit-form-image-delete').click(function(){
		    	...
		    	$.ajax({
		    		type: 'GET',
		    		url: "{{URL::to(Crypt::decrypt($setting->admin_url) . '/slideshow/delete-image')}}/"+value,
...
@section('page_title')
	Slideshow Edit
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/slideshow')}}">Slideshow</a> / <span>Slideshow Edit</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::model($slideshow, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/slideshow/' . $slideshow->id), 'method' => 'PUT', 'files' => true])!!}
						...
						<div class="page-item col-1">
							...
							<div class="page-item-content edit-item-content">
								<div class="edit-form-group">
									...
									{!!Form::hidden('filename_old', $slideshow->filename)!!}
								...
								<div class="edit-form-group">
									...
									@if (file_exists(public_path() . '/usr/img/slideshow/' . $slideshow->id . '_' . Str::slug($slideshow->filename, '_') . '_thumb.jpg'))
										<div class="edit-form-image">
											{!!HTML::image('usr/img/slideshow/' . $slideshow->id . '_' . Str::slug($slideshow->filename, '_') . '_thumb.jpg?lastmod=' . Str::random(5))!!}
											{!!Form::button('Delete Image', ['class'=>'edit-form-image-delete', 'value'=>$slideshow->id . '_' . Str::slug($slideshow->filename, '_')])!!}
